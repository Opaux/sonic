...
## Pmoda (AMP3 Pmod)
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {sdata_0_out_0}]
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {lrclk_out_0}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {sclk_out_0}]
...
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {amp_sd}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {mclk_out}]
...
## Pmodb (I2S Mic) 
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports {lrclk_out_1}]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports {sclk_out_1}]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {sdata_0_in_0}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {mic_lr_sel}]
